...
from baselines.common.atari_wrappers import make_atari, wrap_deepmind, make_ple, wrap_ple
...
def make_env(env_id, env_type, subrank=0, seed=None, reward_scale=1.0, gamestate=None, flatten_dict_observations=True, wrapper_kwargs=None, num_reward = 1, reward_type = 1):
    ...
    elif env_type == 'gym_ple':
        env = make_ple(env_id,num_reward = num_reward)
    else:
        env = gym.make(env_id)
    ...
    if env_type == 'atari':
        ...
        env = wrap_ple(env, **wrapper_kwargs)
    elif env_type == 'retro':
...
def common_arg_parser():
    ...
    parser.add_argument('--num_reward', type=int, default=1)
